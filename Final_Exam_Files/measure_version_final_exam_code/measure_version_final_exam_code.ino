...
#define interval_2 3000
#define interval_3 3000
#define interval_4 3000
#define interval_5 500
#define interval_6 3000
// PID Parameters
volatile int posi = 0;
long prevT = 0;
float eprev = 0;
...
void loop() {
  ...
  if(state == 2){ 
    // lift main sail
    while((pos_lift < 170) && ( pos_left > 45 && pos_right < 135 )){
      ...
      Serial.print((pos_lift < 170) && ( pos_left > 45 && pos_right < 135 ));
      Serial.print("\t");
  ...
  if (state == 3){
    ...
    while( Distance() <= (268.5 + 21.5)){
      ...
      while( Distance() <= (80+21.5) && Distance() >= (60+21.5) ){
        Serial.print("\tDistance:");
    ...
    while( Distance() >= 290){
      ...
      Serial.print("pos_turn");
      Serial.println(pos_turn);
      while( Distance() <= (308.5+21.5) && Distance() >= (268.5+21.5) ){
        Serial.print("\tDistance:");
        Serial.print(Distance());        
        brake();
        ReadAndDebounceBotton();
